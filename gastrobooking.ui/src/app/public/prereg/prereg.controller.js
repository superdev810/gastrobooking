...
(function () {
    ...
    function PreregController($state, $scope, $rootScope, $filter, PreregService, $translate) {
        ...
        function getRestaurants(){
            PreregService.getRestaurants().then(function(response){
        ...
        function copyRestorantData(selected_restaurant) {
            ...
            if(selected_restaurant != undefined)
            {
                ...
                vm.selected_restaurant_company_name = vm.selected_restaurant.company_name;
                vm.selected_restaurant_company_address = vm.selected_restaurant.company_address;
            }
        }
        ...
        function saveInvoiceData(){
            ...
            if(vm.invoice.restaurant && parseInt(vm.invoice.invoice_number) && vm.invoice.invoice_value && vm.invoice.invoice_payment
        ...
        function getAllInvoices(){
            PreregService.getAllInvoices('').then(function(response){
